...
TikBook is a companion extension to [RouterOS LSP](https://marketplace.visualstudio.com/items?itemName=TIKOCI.lsp-routeros-ts), akin to a "plus pack". While the LSP is cross-platform and works with any LSP-enabled editor, TikBook is specific to Visual Studio Code (and its forks). 
...
![copilot-ip-add](./media/images/copilot-add-ip.png)
...
**If an error occurs,** an error message will be shown in place of RouterOS statistics when hovering over the TikBook status bar item in the bottom left of VS Code.  The error message should suggest the problem.  For example, if the username/password are wrong, that will be displayed when hovering over TikBook's status bar item.

![status-error-auth](./media/images/status-error-auth.png)
...
![status-hover-success](./media/images/status-success.png)
...
![tikbook-settings](./media/images/settings-tikbook.png)
...
![UTM-on-mac](./media/images/mikropkl-utm.png)
...
![vscode-proxy-support-setting](./media/images/http-proxy-support.png)
...
![palette-top](./media/images/palette-top.png)
...
![palette-setup](./media/images/palette-connection.png)
...
![palette-mgmt](./media/images/palette-mgmt.png)
...
![help-resources-menu](./media/images/palette-help.png)
...
>
> ![help-video-example](./media/images/palette-video-array1.png)
>
...
![menu-log-output](./media/images/palette-logs.png)
...
This is indicated in the top right corner of the notebook:
![kernel-select-tikbook](./media/images/kernel-select-tikbook.png)
![kernel-select-markdown](./media/images/kernel-select-markdown.png)
...
> ![copilot-beep-wrong](./media/images/copilot-beep-wrong.png)

The cell types appear in the notebook toolbar:

![notebook-celladd-toolbar](./media/images/notebook-toolbar-with-goto.png)
...
![markdown-run-output](./media/images/notebook-markdown-runas-pretty.png)
...
![markdown-notebook-pretty](./media/images/notebook-markdown-pretty.png)
...
![json-convert-context-menu](./media/images/converter-context-menu.png)
...
![ros-convert-string-back-to-json](./media/images/converter-rosstring-back2json.png)
...
![multitab-view-annotated](./media/images/multitab-annotated.png)
...
![reopenas-on-markdown](./media/images/reopen-as-on-markdown.png)
...
* With text documnents of either `.md` or `.rsc` type, a TikBook icon will appear that allow reopening as a notebook, respective of format:
  ...
  ![](./media/images/toolbar-openas-tikbook.png)
...
![explorer-copyas](./media/images/explorer-copyas-tikbook.png)
